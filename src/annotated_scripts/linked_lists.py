...
# Method for removing ALL instances of a value from the linked list.
    def remove_all_values(self, value_to_remove):                           
        ...
        while True:                                                         # This while loop will ensure that multiple instances of the remove value
            if current_node.get_value() == value_to_remove:                 # will be removed before moving on to the rest of the linked list.
